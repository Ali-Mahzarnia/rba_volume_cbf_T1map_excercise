...
for (i in 1:length(file_list)) {
  ...
  temp[missings,]$structure = Atlas$Structure[Atlas$index%in%missings] 
    ...
    volumes[i,2:333]=temp$CBF_mean[1:332]/ sum(temp$CBF_mean[1:332])
...
volumes = na.omit(volumes)
 ...
 xlsx::write.xlsx2(volumes, "cbf_list.xlsx" )
#  
# 
...
write.xlsx2(adjustresult, "adjusted_pvalue_cbf.xlsx", sheetName = "All_Pvalues" )
...
write.xlsx2(sig_result , "adjusted_pvalue_cbf.xlsx", sheetName =  name_of_region , append=TRUE )
